...
require 'fastlane/plugin/gitlab_merge_request_participants/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-gitlab_merge_request_participants'
  spec.version       = Fastlane::GitlabMergeRequestParticipants::VERSION
